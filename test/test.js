...
var Taste = taste.Test;
var tasteTest = new Taste();

var check = function (values, expected) {
  return function () {
    me = this;
    values.forEach(function (val) {
      var result = me.cb(val, expected);
      assert.equal(result, expected, "Failed.");
    });
    return true;
  };
};
var checkF = function (value, expected) {
  return function () {
    return typof.value(value) !== expected;
  };
};

var checkIs = function (value, expected) {
  return function () {
    return typof.is(value, expected);
  };
};

var checkIsF = function (value, expected) {
  return function () {
    return !typof.is(value, expected);
  };
};
